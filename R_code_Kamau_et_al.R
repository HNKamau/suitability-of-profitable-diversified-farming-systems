...
fdata_asc -> raster(paste0(getwd(),"/Final_models/M_1_F_lq_Set_1/final_data_avg.asc")
...
## SUBSEQUENT MODELS 
# We based our subsequent models on Jackknife's results of the first model. We interogated the variables of importance to the model. The top 5 variables in contribution to the models and possession of unique information, were choosen as input variables for the second round. Suitability predction was then run as in the above lines and the results used to make bivariate maps using spatial maps from Zabel et al., 2019
